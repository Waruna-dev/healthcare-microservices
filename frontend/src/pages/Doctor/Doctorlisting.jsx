  ...
  const fetchDoctors = async () => {
    try {
      ...
      if (data.success && data.doctors) {
        ...
        setError('Unable to fetch doctors from database. Showing sample data.');
      }
    } catch (error) {
    ...
    return [
      {
        ...
        email: 'amara.patel@hospital.com',
      ...
      },
      {
        ...
        email: 'rohan.silva@hospital.com',
      ...
      },
      {
        ...
        email: 'priya.mendis@hospital.com',
      ...
      },
      {
        ...
        reviewCount: 143,
        isAvailable: true,
        bio: 'Expert in joint replacement, sports injuries and minimally invasive spine surgery.',
      ...
      },
      {
        ...
        reviewCount: 261,
        isAvailable: true,
        bio: 'Specializes in medical and cosmetic dermatology, skin cancer screening and laser treatments.',
        profileImage: 'https://randomuser.me/api/portraits/women/29.jpg',
        email: 'niluka.j@hospital.com',
      ...
      },
      {
        ...
        reviewCount: 189,
        isAvailable: false,
        bio: 'Focused on mood disorders, anxiety, PTSD and adult psychiatric care.',
        profileImage: 'https://randomuser.me/api/portraits/men/77.jpg',
        email: 'ashen.w@hospital.com',
