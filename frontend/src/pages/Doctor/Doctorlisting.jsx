            ...
            {filteredDoctors.map((doctor) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-2xl shadow-sm border-2 border-blue-200 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-blue-400"
                >
                  {/* Card Top Gradient */}
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-start gap-3 mb-4">
                      <div className="relative flex-shrink-0">
                        <img
                          src={getImageUrl(doctor.profileImage) || `https://ui-avatars.com/api/?name=${encodeURIComponent(doctor.name.replace('Dr. ', ''))}&background=007bff&color=fff&size=128`}
                          alt={doctor.name}
                          className="w-16 h-16 rounded-full object-cover border-3 border-white shadow-md"
                          onError={(e) => {
                            e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(doctor.name.replace('Dr. ', ''))}&background=007bff&color=fff&size=128`;
                          }}
                        />
                    ...
                    <div className="grid grid-cols-3 gap-2 py-3 border-t border-b border-gray-100 mb-3">
                      ...
                      <div className="text-center">
                        ...
                        <p className={`text-xs font-semibold ${doctor.isAvailable ? 'text-blue-600' : 'text-gray-500'}`}>
