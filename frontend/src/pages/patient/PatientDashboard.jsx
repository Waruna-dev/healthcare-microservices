                        ...
                        <div className="w-full">
                          ...
                          {aiData.abnormalitiesFound?.length > 0 ? (
                            ...
                            <p className="text-white/80 text-sm leading-relaxed mb-3">
                              No major abnormalities detected. Consider a routine checkup for preventive care.
                            </p>
                          )}
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <motion.div variants={itemVars} className="bg-surface-container-lowest p-8 rounded-[2rem] shadow-ambient border border-outline-variant/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold font-headline">My Appointments</h2>
              </div>
              ...
              {appointments.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Link 
                    to="/doctor/listing" 
                    className="inline-block mt-4 px-4 py-2 bg-primary text-white rounded-xl text-sm font-semibold hover:bg-primary/90 transition-colors"
                  >
                ...
                <div className="space-y-3 max-h-[400px] overflow-y-auto">
                  {appointments.map((appt, idx) => (
                    <div key={idx} className="p-4 bg-surface-container-low rounded-xl border border-outline-variant/20 hover:shadow-md transition-all">
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <UserIcon size={14} className="text-primary" />
                            <h4 className="font-bold text-on-surface text-sm">{appt.doctorName}</h4>
                          </div>
                          <p className="text-xs text-primary mb-2">{appt.doctorSpecialty}</p>
                          <div className="grid grid-cols-2 gap-2 mt-2">
                            ...
                            <div className="flex items-center gap-1 text-xs text-on-surface-variant">
                              ...
                              <span className="text-secondary font-semibold">Rs. {appt.fee}</span>
                            </div>
                            <div className="flex items-center gap-1 text-xs text-on-surface-variant">
                          ...
                          {appt.reason && (
                            <p className="text-xs text-on-surface-variant mt-2 pt-2 border-t border-outline-variant/20">
              ...
              {appointments.length > 0 && (
                <button 
                  ...
                  className="w-full mt-4 text-center text-sm text-primary font-semibold hover:underline"
                >
